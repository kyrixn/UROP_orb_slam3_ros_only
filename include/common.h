...
void publish_topics(ros::Time, bool finished, double xangle =7.8, double yangle = 10, double zangle = 100, Eigen::Vector3f = Eigen::Vector3f::Zero());

void publish_camera_pose(Sophus::SE3f, ros::Time);
void publish_tracking_img(cv::Mat, ros::Time);
void publish_tracked_points(std::vector<ORB_SLAM3::MapPoint*>, ros::Time, double xangle =7.8, double yangle = 10, double zangle = 100);
void publish_all_points(std::vector<ORB_SLAM3::MapPoint*>, ros::Time, bool finished, double xangle =7.8, double yangle = 10, double zangle = 100);
...
sensor_msgs::PointCloud2 mappoint_to_pointcloud(std::vector<ORB_SLAM3::MapPoint*>, ros::Time, double xangle =7.8, double yangle = 10, double zangle = 100);