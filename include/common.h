...
void publish_topics(ros::Time, double xangle =7.8, double yangle = 10, double zangle = 100, Eigen::Vector3f = Eigen::Vector3f::Zero());
...
void publish_all_points(std::vector<ORB_SLAM3::MapPoint*>, ros::Time, double xangle =7.8, double yangle = 10, double zangle = 100);
